const fs = require('fs-extra') 
 ...
 global.github = 'https://gith' 
 global.location = 'Sri lanka, Monaragala' 
 global.gurl = 'https://instagram.com/' // add your username 
 global.sudo = process.env.SUDO || '94742443114' 
 global.devs = '94742443114'; 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'QUEEN-NICKY' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'dumidu' : process.env.OWNER_NAME,  
   author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'Dumidu' : process.env.PACK_INFO.split(";")[0], 
   auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS, 
   packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'QUEEN-NICKY' : process.env.PACK_INFO.split(";")[1],
